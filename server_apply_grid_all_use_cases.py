...
#            input_dim = 55
        ...
        if model_num == 1:
            ...
            model_1.add(Conv1D(50, kernel_size=6, strides=1, padding="same", activation = 'relu'))
            model_1.add(Conv1D(40, kernel_size=11, strides=1, padding="same", activation = 'relu'))
            model_1.add(Conv1D(20, kernel_size=2, strides=2, padding="same", activation = 'relu'))
            ...
            model_2.add(Conv1D(11, kernel_size=5, strides=5, padding="same", activation = 'relu'))
            ...
            model_3.add(Conv1D(24, kernel_size=4, strides=5, padding="same", activation = 'relu'))
            ...
            model_4.add(Conv1D(24, kernel_size=5, strides=2, padding="same", activation = 'relu'))
            ...
            model_5.add(Conv1D(28, kernel_size=2, strides=2, padding="same", activation = 'relu'))
            model_5.add(Conv1D(20, kernel_size=9, strides=1, padding="same", activation = 'relu'))
            ...
            model_6.add(Conv1D(48, kernel_size=8, strides=1, padding="same", activation = 'relu'))
            model_6.add(Conv1D(40, kernel_size=8, strides=1, padding="same", activation = 'relu'))
            model_6.add(Conv1D(20, kernel_size=2, strides=2, padding="same", activation = 'relu'))
            model_6.add(Conv1D(10, kernel_size=2, strides=2, padding="same", activation = 'relu'))
...
#starting from use case 2 since use case 1 was partially run
...
for use_case in Insurance_use_cases:
    ...
    for model_num in range(1,no_of_models+1,1):
        ...
        num_models_already_created = 245
        ...
        for index in range(num_models_already_created,len(param_grid)):
            ...
            if params['decay'] == 'decay':
                ...
                while(model == None):
                    ...
                    if try_num > 0:
                        print("Try " + str(try_num) + " : Model returned as None")
                    try_num+=1
                        
                
#                model = create_model(use_case, model_num, optimizer, dropout)
#                if model == None:
#                    print("Try 1 : Model returned as None")
#                    model = create_model(use_case, model_num, optimizer, dropout)
#                    if model == None:
#                        print("Try 2 : Model returned as None")
#                        model = create_model(use_case, model_num, optimizer, dropout)
