...
model_1_plot_info = plotMetricsWithThreshold(model_1, X_test, y_test, fig_name=fig_name, fig_path = None,
...
report_df.to_csv("Report_CNN_V1_noClaim_predictRenewal_10_models_1.csv",index=False)